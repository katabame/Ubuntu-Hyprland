...
case "$1" in
    ...
    canary)
        ...
        HYPRPAPER_TAG=`curl https://api.github.com/repos/hyprwm/hyprpaper/releases/latest | jq -r '.tag_name'`
    ;;
    *)
        ...
        HYPRPAPER_TAG='v0.7.0'                   # https://github.com/hyprwm/hyprpaper/releases
    ;;
esac
...
# 100 tweak hyprland commands
echo "::group::Tweak hyprland commands"
git clone --depth 1 --branch ${HYPRPAPER_TAG} https://github.com/hyprwm/hyprpaper.git
cd ./hyprpaper
    apt_install libxcb-util-dev libmagic-dev
    cmake --no-warn-unused-cli -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/usr -S . -B ./build
