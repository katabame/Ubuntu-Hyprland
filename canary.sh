...
git clone --depth 1 -b `curl https://gitlab.freedesktop.org/api/v4/projects/798/repository/tags | jq -r '.[0].name'` https://gitlab.freedesktop.org/xorg/util/macros.git
cd ./macros
    ./autogen.sh
    ./configure
...
git clone --depth 1 -b `curl https://api.github.com/repos/hyprwm/hyprlang/releases/latest | jq -r '.tag_name'` https://github.com/hyprwm/hyprlang.git
cd ./hyprlang
...
git clone --depth 1 -b `curl https://api.github.com/repos/hyprwm/hyprcursor/releases/latest | jq -r '.tag_name'` https://github.com/hyprwm/hyprcursor.git
cd ./hyprcursor
...
git clone --depth 1 -b `curl https://gitlab.freedesktop.org/api/v4/projects/121/repository/tags | jq -r '.[0].name'` https://gitlab.freedesktop.org/wayland/wayland.git
cd ./wayland
...
git clone --depth 1 -b `curl https://gitlab.freedesktop.org/api/v4/projects/2891/repository/tags | jq -r '.[0].name'` https://gitlab.freedesktop.org/wayland/wayland-protocols.git
...
git clone --depth 1 -b `curl https://api.github.com/repos/hyprwm/hyprland-protocols/releases/latest | jq -r '.tag_name'` https://github.com/hyprwm/hyprland-protocols.git
...
git clone --depth 1 -b `curl https://api.github.com/repos/hyprwm/xdg-desktop-portal-hyprland/releases/latest | jq -r '.tag_name'` --recurse-submodules https://github.com/hyprwm/xdg-desktop-portal-hyprland.git
...
git clone --depth 1 -b `curl https://api.github.com/repos/hyprwm/hyprwayland-scanner/releases/latest | jq -r '.tag_name'` https://github.com/hyprwm/hyprwayland-scanner.git
...
git clone --depth 1 -b `curl https://api.github.com/repos/hyprwm/hyprland/releases/latest | jq -r '.tag_name'` --recurse-submodules https://github.com/hyprwm/hyprland.git
cd ./hyprland
